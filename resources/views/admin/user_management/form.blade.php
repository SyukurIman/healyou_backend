            ...
            <div class="d-flex flex-column h-100">
                ...
                <form id="form-data" method="post" autocompleted="off" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col mt1">
                            <label for="payment_status">Status Pengguna</label>
                            <select  class="form-control input_form" name="is_admin" id="is_admin" required >
                                <option value="0" {{ isset($data_user) ? ($data_user->is_admin == 0 ? 'selected' : '' ) : '' }}>Pengguna Biasa</option>
                                <option value="1" {{ isset($data_user) ? ($data_user->is_admin == 1 ? 'selected' : '' ) : '' }}>Admin</option>
                            </select>
                        </div>
                    </div>
